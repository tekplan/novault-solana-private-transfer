        ...
        <div className="grid grid-cols-12 gap-8">
          ...
          <div className="col-span-6 md:col-span-3">
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <a className="text-secondary hover:text-[var(--mint)]" href="#foundation">
                  Architecture
                </a>
              </li>
              <li>
                <a className="text-secondary hover:text-[var(--mint)]" href="#flow">
                  Confidential Flow
                </a>
              </li>
              <li>
                <a className="text-secondary hover:text-[var(--mint)]" href="#os">
                  Transfer OS
                </a>
              </li>
            </ul>
          ...
          <div className="col-span-6 md:col-span-2">
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <a className="text-secondary hover:text-[var(--mint)]" href="/docs">
                  Docs
                </a>
              </li>
              <li>
                <a className="text-secondary hover:text-[var(--mint)]" href="#">
                  GitHub
                </a>
              </li>
              <li>
          ...
          <div className="col-span-12 md:col-span-2">
            ...
            <div className="text-sm text-secondary flex items-center gap-2">
              <span className="w-1.5 h-1.5 rounded-full bg-[var(--mint)] pulse-soft" /> Mainnet
              ready
            </div>
          </div>
        </div>
